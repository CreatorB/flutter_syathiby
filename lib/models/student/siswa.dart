...
abstract class Siswa with _$Siswa {
  const factory Siswa({
    ...
    @JsonKey(name: 'id_kesehatan') String? idKesehatan,
    @JsonKey(name: 'keterangan_sakit') String? keteranganSakit,
    @JsonKey(name: 'keterangan_izin') String? keteranganIzin,
    @JsonKey(name: 'izin_id') String? izinId,
    @JsonKey(name: 'izin_jenis') String? izinJenis,
    @JsonKey(name: 'izin_alasan') String? izinAlasan,
    @JsonKey(name: 'izin_tanggal_awal') String? izinTanggalAwal,
    @JsonKey(name: 'izin_tanggal_akhir') String? izinTanggalAkhir,
    @JsonKey(name: 'kesehatan_diagnosa') String? kesehatanDiagnosa,
    @JsonKey(name: 'kesehatan_keluhan') String? kesehatanKeluhan,
    @JsonKey(name: 'kesehatan_tanggal') String? kesehatanTanggal,
    @JsonKey(name: 'kesehatan_jam') String? kesehatanJam,
    @JsonKey(name: 'kesehatan_istirahat') String? kesehatanIstirahat,
    @JsonKey(name: 'kesehatan_dijemput') String? kesehatanDijemput,
    @JsonKey(name: 'kesehatan_penanganan') String? kesehatanPenanganan,
